...
<head>
    ...
    <title>Tugas Akhir Basdat</title>
    <!-- Favicon icon -->
...
<script>
    window.onload = function() {
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            title: {
                text: "Perbandingan Toko Online Indonesia"
            },
            data: [{
                type: "doughnut",
                indexLabel: "{symbol} - {y}",
        ...
        <div class="header" style="margin-left:0px;width:100%">
            <div class="header-content clearfix">
                ...
                <div class="nav-control">
                    <div class="hamburger">
                        <a href=".">
                            <span class="toggle-icon"><i class="icon-home"></i></span>
                        </a>
                    </div>
                </div>
        ...
        <div class="content-body">
            ...
            <div class="container-fluid mt-3">
                <div class="row">
                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?= $row['jumlah_order'] ?></h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="table-customer.php">
                            <div class="card gradient-3">
                                <div class="card-body">
                                    <h3 class="card-title text-white">Total Customers</h3>
                                    <div class="d-inline-block">
                                        <h2 class="text-white"><?= $rows['jumlah_customers'] ?></h2>
                                        <p class="text-white mb-0">Jan - March 2019</p>
                                    </div>
